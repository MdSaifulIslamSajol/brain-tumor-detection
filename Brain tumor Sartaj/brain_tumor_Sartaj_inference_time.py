...
sys.stdout = open(f"./results/console_output_lr{learning_rate}_bs{batchsize}_Sartaj_inference_time.txt", "w")
...
#%%
dataset_path = "/data/saiful/pilot projects/Brain Tumor Classification Sartaj/"
train_path = "/data/saiful/pilot projects/Brain Tumor Classification Sartaj/Training/"
test_path = "/data/saiful/pilot projects/Brain Tumor Classification Sartaj/Testing/"
image_size = (224,224)
