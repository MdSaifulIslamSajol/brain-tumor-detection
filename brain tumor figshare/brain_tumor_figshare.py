...
def train_test_plot(method_name = "_"):
    ...
    plt.tight_layout()
    plt.savefig(f"./results/{method_name}_lr{learning_rate}_bs{batchsize}_accuracy_curve.png", dpi=300)  # Save the figure with high resolution
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig(f"./results/{method_name}_lr{learning_rate}_bs{batchsize}_loss_curve.png", dpi=300)
    plt.show()
